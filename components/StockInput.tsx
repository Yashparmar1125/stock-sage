...
const stockMapping: { [key: string]: string } = {
  ...
  'L&T Technology Services': 'LTTS', 'Lupin Limited': 'LUPIN', 'Mahindra Lifespace Developers': 'MAHLIFE', 'Motherson Sumi': 'MOTHERSUMI',
  'National Aluminium Company': 'NALCO', 'Nestlé India': 'NESTLEIND', 'Oberoi Realty': 'OBEROIRLTY', 'Pidilite Industries': 'PIDILITIND',
  'Piramal Enterprises': 'PIRAMAL', 'Power Finance Corporation': 'PFC', 'Power Grid Corporation': 'POWERGRID', 'Reliance Industries': 'RELIANCE',
  'Shree Cement': 'SHREECEM', 'Siemens Ltd': 'SIEMENS', 'State Bank of India': 'SBI', 'Sun Pharmaceutical Industries': 'SUNPHARMA',
  'Tata Consultancy Services': 'TCS', 'Tech Mahindra': 'TECHM', 'Titan Company': 'TITAN', 'UltraTech Cement': 'ULTRACEMCO', 
  'Voltas': 'VOLTAS', 'Wipro Limited': 'WIPRO', 'Zee Entertainment Enterprises': 'ZEEL', 'Zomato': 'ZOMATO','TCS': 'TCS', 'INFY': 'INFY', 'RELIANCE': 'RELIANCE', 'HDFC': 'HDFC', 
